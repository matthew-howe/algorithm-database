...
function highestProductOf3(arrayOfInts) {
    ...
    if (arrayOfInts.length < 3) throw new Error("Less than 3 integers in the input");

    arrayOfInts = arrayOfInts.sort((a, b) => a - b);

    let highestProductOf3 = arrayOfInts[0] * arrayOfInts[1] * arrayOfInts[2];
    let highestProductOf2 = arrayOfInts[0] * arrayOfInts[1];
    let highest = arrayOfInts[0] > arrayOfInts[1] ? arrayOfInts[0] :
        arrayOfInts[1];
    let lowestProductOf2 = arrayOfInts[0] * arrayOfInts[1];
    let lowest = arrayOfInts[0] < arrayOfInts[1] ? arrayOfInts[0] :
        arrayOfInts[1];
