...
function getPossibleMoves(chessboard, position) {
    // Returns an nested array of possible moves based on
    // current knight position and chessboard
    // ( does not account for squares already visited )
...
function knightTour(chessboardSize) {
    ...
    return solutionWasFound ? 'Solution was found!' : 'Solution was not found!';
}
